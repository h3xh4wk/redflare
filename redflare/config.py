...
are overridden by settings in /etc/redflare/redflare.conf and/or
~/.redflare.conf (by default) and therefore, any default configurations
...
dcf['app_name'] = 'redflare' # name for cli like /etc/<app_name>
dcf['app_egg_name'] = 'redflare' # name from setup.py
dcf['app_module'] = 'redflare' # name of the library dir
